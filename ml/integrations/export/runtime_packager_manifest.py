...
EXPORT_DECODER_CORE_FILENAME = "decoder_core.py"
EXPORT_DECODER_OUTPUT_FILENAME = "decoder_output.py"
EXPORT_DECODER_HOST_FILENAME = "decoder_host.py"
EXPORT_DECODER_HOST_COMPAT_FILENAME = "decoder_host.py"
EXPORT_DECODER_RUNTIME_MODEL_FILENAME = "decoder_runtime.py"
EXPORT_DECODER_RUNTIME_RECIPE_FILENAME = "decoder_runtime.py"
...
_REMOTE_CODE_ARTIFACT_SPECS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    (EXPORT_ROPE_FILENAME, ("runtime", "model", "rope.py")),
    ...
    (EXPORT_DECODER_CORE_FILENAME, ("modeling", "decoder_core.py")),
