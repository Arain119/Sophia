...
_RUNTIME_STATE_RUN_CONFIG_FIELDS: dict[str, str] = {
    ...
    "base_stage_seq_len": "base_stage_seq_len",
    "target_tokens_per_microbatch": "target_tokens_per_microbatch",
}
_RUNTIME_STATE_COERCERS: dict[str, object] = {
    ...
    "ema_update_interval": coerce_int,
    "ema_decay": coerce_float,
    "target_tokens_per_update": coerce_int,
    "base_stage_seq_len": coerce_int,
    "target_tokens_per_microbatch": coerce_int,
}
