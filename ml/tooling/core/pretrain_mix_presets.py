...
_PRETRAIN_TARGETS_FRAC: dict[str, float] = _normalized_targets_frac({
    ...
    # - chat/reasoning stay in SFT/post-training, not pretraining
...
_PRETRAIN_DECAY_TARGETS_FRAC: dict[str, float] = _normalized_targets_frac({
    # WSD decay-phase mixture: concentrate the schedule's final low-LR steps on
    # the knowledge-dense, highest-quality buckets (books/wiki/math), keep a
    # compact code core, and trim long-tail buckets.
    "zh_books:UNKNOWN": 0.2600,
    "en_books:UNKNOWN": 0.2100,
    "zh_wiki:UNKNOWN": 0.1700,
    "en_wiki:UNKNOWN": 0.1700,
    "math:UNKNOWN": 0.0800,
    "code_general_py:Python": 0.0300,
    "code_gcclean:Python": 0.0400,
    "zh_discourse:UNKNOWN": 0.0100,
    "en_discourse_general:UNKNOWN": 0.0100,
    "translation:UNKNOWN": 0.0050,
})
...
PRESETS: dict[str, PretrainMixPreset] = {
    ...
    "pretrain_decay": PretrainMixPreset(
        name="pretrain_decay",
        total_tokens_eos=2_400_000_000,
        sources=_PRETRAIN_TRAIN_SOURCES,
        targets_frac=_PRETRAIN_DECAY_TARGETS_FRAC,
    ),
