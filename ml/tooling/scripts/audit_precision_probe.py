...
def build_precision_probe_report(
    *,
    ...
    return {
        ...
        "production_gate": {
            **gate_payload,
            "selected_runtime_validation_status": str(policy.runtime_validation_status),
            "selected_runtime_validation_requirements": runtime_validation_requirements,
            "bf16_baseline_passed": bool(bf16_passed),
            "release_pretrain_safe": False,
            "required_before_release": runtime_validation_requirements,
        },
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Probe release-pretrain precision safety. Low precision fails closed."
    )
